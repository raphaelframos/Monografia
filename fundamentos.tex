...
Sistemas de reconhecimento automático de voz, tem como objetivo, transformar um sinal analógico(fala) em modo textual. Com o resultado da tradução, pode-se tomar decisões, traduzir para outra língua, etc.
...
\section{Fatores que Interferem no Desempenho}
